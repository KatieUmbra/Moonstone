...
struct vertex_element
{
	...
	vertex_element(glm::vec3 m_normal, glm::vec2 m_position, glm::vec2 m_uv, std::uint32_t m_tex_layer)
		: m_normal(m_normal), m_position(m_position), m_uv(m_uv), m_tex_layer(m_tex_layer)
	{
	}
